 ...
 * 
*/
export function getStoreInfo(id,data){
  return request.get('store/merchant/chome/'+id,data, {
			noAuth: true
		});
}
/**
 ...
 * 
*/
export function getMoneyList(param){
  return request.get('user/agent_bill',param);
}
...
export function switchType(type){
  return request.post('user/switch/'+type);
}
...
export function getSearchList(){
  return request.get('user/search_history');
}
...
export function clearSearch(){
  return request.get('user/delete_history');
}
...
export function registerForget(data) {
  return request.post("user/change_pwd", data, { noAuth: true });
}
/**
 * 获取用户中心菜单
 *
 ...
 * 
*/
export function getBankLst(){
  return request.get('user/bank/lst');
}
...
export function getBankInfo(id){
  return request.get('user/bank/detail/'+id);
}
/**
 * 添加银行卡
 * 
*/
export function postBankCreate(data){
  return request.post('user/bank/create',data);
}
 ...
 * 
*/
export function agent_recharge(data){
  return request.post('user/agent_recharge',data)
}
 ...
 * 
*/
export function agent_lst(data){
  return request.get('user/agent_lst',data)
}
 ...
 * 
*/
export function agent_all(data){
  return request.get('user/agent_all',data)
}
...
{
	return request.post("user/spread",{spread_spid:puid});
}
...
export function getQiandaoInfo() {
  return request.get('user/qiandao_info');
}
// 签到
export function getQiandao() {
  return request.get('user/qiandao');
}
// 签到提醒
export function getQiandaoTx(data) {
  return request.get('user/qiandao_tx',data);
}
// 签到提醒
export function getSpreadListTj(data) {
  return request.get('user/spread_list_tj',data);
}
 ...
 * 
*/
export function postBankDelete(data){
  return request.post('user/bank/delete',data);
}
 ...
 * 
*/
export function postBankDefault(data){
  return request.post('user/bank/default',data);
}