...
export function getSessionKey(data) {
	return request.post("auth/mp_sessionkey", data, {
		noAuth: true
	});
}
export function login(data) {
	return request.post("auth/mp_profile", data, {
		noAuth: true
	});
}

export function getWxLoginOpenId(data) {
	return request.post("auth/mp_wxlogin", data, {
		noAuth: true
	});
}
/**
