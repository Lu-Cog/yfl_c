<template>
	<div>
		<view class='flash-sale'>
			<view class='header'>
				<img mode="widthFix" class="presellBg" src="../static/images/presell_bg.png" alt="">	
			</view>
					...
					<block v-for="(item,index) in presellList" :key='index'>
						<view class='item acea-row row-between-wrapper' @tap='goDetails(item)'>
							...
							<view class='text acea-row row-column-around'>
								...
								<view class='booking'>
									<text v-if="item.presell_type != 0 && active != 0" class="count" style="color: #999;">已预定{{item.tattend_one.pay ? item.tattend_one.pay : 0}}{{item.product.unit_name}}</text>
