<template>
	...
	<view class="page purchase_detailed">
		<view class="top_body">
			<image class="img-bg" src="https://yfl-public.oss-cn-shenzhen.aliyuncs.com/img/bg.jpg" mode="widthFix"></image>
			<view class="calendar_blcok flex-bt">
				<view class="left flex-center" @click="open">
					<image class="i-date" src="https://yfl-public.oss-cn-shenzhen.aliyuncs.com/img/date.png" mode="widthFix"></image>
					<text class="date">当前 {{date}}</text>
				</view>
				<uni-calendar ref="calendar" :insert="false" @confirm="confirm"></uni-calendar>
				<image class="i-left" src="https://yfl-public.oss-cn-shenzhen.aliyuncs.com/img/jiantou_left2.png" mode="widthFix"></image>
			</view>
