<template>
	<view>
		<view class='productList'>
			...
			<rightSlider v-if="rightBox" :status="rightBox" :brandList="brandList" :price_on="where.price_on" :price_off="where.price_off" @confirm="confirm" @close="close"></rightSlider>
		</view>
